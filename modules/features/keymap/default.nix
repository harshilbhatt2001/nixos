...
let
  ...
  bind = action: attrs: { inherit action; args = [ ]; desc = ""; locked = false; cooldown = null; } // attrs;
  act = action: desc: bind action { inherit desc; };
  spawn = args: desc: bind "spawn" { inherit args desc; };
  media = args: desc: bind "spawn" { inherit args desc; locked = true; };

  workspaceBinds = lib.listToAttrs (lib.concatMap (n: let s = toString n; in [
    (lib.nameValuePair "Mod+${s}" (bind "focus-workspace" { args = [ n ]; desc = "focus workspace ${s}"; }))
    (lib.nameValuePair "Mod+Ctrl+${s}" (bind "move-to-workspace" { args = [ n ]; desc = "move window to workspace ${s}"; }))
  ]) (lib.range 1 9));
  ...
  binds = {
    ...
    "Mod+WheelScrollRight" = bind "focus-workspace-next" { desc = "thumb wheel: next workspace"; cooldown = 150; };
    "Mod+WheelScrollLeft" = bind "focus-workspace-prev" { desc = "thumb wheel: previous workspace"; cooldown = 150; };
  ...
  toNiri = { resolve ? { }, actions ? { } }:
    let
      translators = niriActions // {
        spawn = b: {
      ...
      render = key: b:
        let
          ...
          props = lib.optionalAttrs b.locked { allow-when-locked = true; }
  ...
  hyprMods = { Mod = "SUPER"; Super = "SUPER"; Shift = "SHIFT"; Ctrl = "CTRL"; Alt = "ALT"; };
  hyprKeys = {
    Return = "RETURN"; Space = "space"; Print = "PRINT"; Escape = "ESCAPE"; Tab = "TAB";
    BackSpace = "BACKSPACE"; Delete = "DELETE"; Home = "HOME"; End = "END";
    Left = "LEFT"; Right = "RIGHT"; Up = "UP"; Down = "DOWN";
    Minus = "minus"; Equal = "equal"; Slash = "slash"; Backslash = "backslash";
    BracketLeft = "bracketleft"; BracketRight = "bracketright";
    Comma = "comma"; Period = "period"; Semicolon = "semicolon"; Apostrophe = "apostrophe"; Grave = "grave";
    WheelScrollUp = "mouse_up"; WheelScrollDown = "mouse_down";
    WheelScrollLeft = "mouse_left"; WheelScrollRight = "mouse_right";
    MouseLeft = "mouse:272"; MouseRight = "mouse:273"; MouseMiddle = "mouse:274";
    MouseBack = "mouse:275"; MouseForward = "mouse:276";
  };
  ...
  toHyprKey = key:
    let
      ...
      k = lib.last parts;
      k' = hyprKeys.${k} or (if builtins.stringLength k == 1 then lib.toLower k else k);
    in
